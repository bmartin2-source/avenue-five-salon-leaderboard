...
| --- | --- | --- |
| `AFI-2401` | `Reyes` | Jordan R. · Cosmetology · North · opted in |
| `AFI-2402` | `Cruz` | Opted out · Esthetics · South · shows as `Student AFI-2402` |
| `AFI-2403` | `Miles` | Casey M. · Barbering · North |
